...
import GeneralHs from './GeneralHs'
import OverviewHs from './OveriewHs'
...
function CoreHs() {
    ...
    const toastii = ()=>{
      toast("Hospital Listing Submitted Successfully");
    }
    const toastiyy = ()=>{
      toast("Hospital Overview Submitted");
    }

    const shiftpage=()=>{
       setActiveTab('Hospital-overview')
    }
