...
function UnGeneral({onShift, setUnname, onSubmit}) {

    const[name, setName]=useState('')
    const[shortNames, setShortNames]=useState([])
    const[untype, setuntype]=useState('')
    const [category, setCategory] = useState([]);
    const[unfull, setunFull]=useState('')
    const[unshort, setunshort]=useState('')
    const[unnick, setunnick]=useState('')
    ...
    const handleSubmit=async(e)=>{
        ...
        try {
          ...
          formData.append('untype',untype);
          formData.append('category',category);
          formData.append('unfull', unfull);
          formData.append('unshort', unshort);
          formData.append('unnick', unnick);
    ...
    mob.forEach((number, index) => {
      formData.append(`mob[${index}]`, number);
          ...
          const response = await axios.post('http://localhost:4000/api/unigendetails', formData)
    ...
    <div className="card-text h-full ">
                            <form className="space-y-4" onSubmit={handleSubmit}>
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                                              ...
                                                              <div>
                                                                 <label htmlFor="status" className="form-label items-center">Univeristy Type<span style={{ color: 'red' }}>*</span></label>
                                                                   <div className="input-area relative flex">
                                                                       <div className="flex space-x-4 items-center mb-3">
                                                                           <input type="radio" id="Private Univeristy" name="UniveristyType" value="Private Univeristy" onChange={(e) => setuntype(e.target.value)} required/>
                                                                           <label htmlFor="PrivateUniveristy" className="text-sm ml-1">Private Univeristy</label>
                                                                       </div>
                                                                       <div className="flex space-x-4 items-center mb-3 ml-5">
                                                                           <input type="radio" id="Government Univeristy" name="UniveristyType" value="Government Univeristy" onChange={(e) => setuntype(e.target.value)} required/>
                                                                           <label htmlFor="GovernmentUniveristy" className="text-sm ml-1">Government Univeristy</label>
                                                                       </div>
                                                                   </div>
                                                              </div>
                                                              ...
                                                              <div className="input-area relative">
                                                                <label for="largeInput" className="form-label">Univeristy Full Name<span style={{ color: 'red' }}>*</span></label>
                                                                <input type="text" className="form-control" placeholder="Univeristy Full Name" value={unfull} onChange={(e) => setunFull(e.target.value)} required/>
                                                            </div>

                                                            <div className="input-area relative">
                                                                <label for="largeInput" className="form-label">Univeristy Short Name</label>
                                                                <input type="text" className="form-control" placeholder="Univeristy Short Name" value={unshort} onChange={(e) => setunshort(e.target.value)}/>
                                                            </div>
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">

                                                            <div className="input-area relative">
                                                                <label for="largeInput" className="form-label">Univeristy Nick Name<span style={{ color: 'red' }}>*</span></label>
                                                                <input type="text" className="form-control" placeholder="unlege Nick Name" value={unnick} onChange={(e) => setunnick(e.target.value)}/>
                                                            </div>

                                                            <div className="form-group">
                                                                  <label for="exampleFormControlFile1">Univeristy Logo<span style={{ color: 'red' }}>*</span></label>
