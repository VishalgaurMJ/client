...
function General({ onShift, setColname, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://server-dashboard-zeta.vercel.app/api/colgendetails",
        formData
      );
  ...
  useEffect(() => {
    const fetchcountries = async () => {
      try {
        const response = await axios.get(
          "https://server-dashboard-zeta.vercel.app/api/getallcountries"
        );
  ...
  useEffect(() => {
    const fetchzones = async () => {
      try {
        const response = await axios.get(
          "https://server-dashboard-zeta.vercel.app/api/getallzones"
        );
  ...
  useEffect(() => {
    const fetchstates = async () => {
      try {
        const response = await axios.get(
          "https://server-dashboard-zeta.vercel.app/api/getallstates"
        );
  ...
  useEffect(() => {
    const fetchcities = async () => {
      try {
        const response = await axios.get(
          "https://server-dashboard-zeta.vercel.app/api/getallcities"
        );
  ...
  const [colaf, setColaf] = useState([]);
  const [colp, setcolap] = useState([]);

  useEffect(() => {
    const fetchmedidata = async () => {
      try {
        const response = await fetch(
          "https://server-dashboard-zeta.vercel.app/api/getallmedidata"
        );
        if (response.ok) {
          ...
          const collaff = AllData.filter(
            (item) => item.category === "Affiliated" && item.type === "College"
          );
          setColaf(collaff);

          const colap = AllData.filter(
            (item) => item.category === "Approaved" && item.type === "College"
          );
          setcolap(colap);
        } else {
  ...
  const optionsaff = colaf.map((item) => ({
    value: item.nugname,
    label: item.nugname,
  }));

  const optionsapp = colp.map((item) => ({
    value: item.nugname,
    label: item.nugname,
  }));
    ...
    <div className="card-text h-full ">
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
            ...
            <div className="input-area relative flex">
              <div className="flex space-x-4 items-center mb-3">
                <input
                  ...
                  required
                />
                <label htmlFor="PrivateCollege" className="text-sm ml-1">
                  Private College
                </label>
              </div>
              <div className="flex space-x-4 items-center mb-3 ml-5">
                <input
                  ...
                  required
                />
                <label htmlFor="GovernmentCollege" className="text-sm ml-1">
                  Government College
                </label>
              </div>
            </div>
          ...
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              College Full Name<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              ...
              value={colfull}
              onChange={(e) => setColFull(e.target.value)}
              required
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              College Nick Name<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              className="form-control"
              placeholder="College Nick Name"
              value={colnick}
              onChange={(e) => setColnick(e.target.value)}
            />
          </div>

          <div className="form-group">
            <label for="exampleFormControlFile1">
              College Logo<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="file"
          ...
          <div className="form-group">
            <label for="exampleFormControlFile2">
              Desktop Cover<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="file"
              className="form-control-file mt-2"
          ...
          <div className="form-group">
            <label for="exampleFormControlFile3">
              Mobile Cover<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="file"
              className="form-control-file mt-2"
              ...
              accept=".jpg, .jpeg, .png"
              ref={mobinput}
              onChange={(e) => setMobcover(e.target.files[0])}
              required
            />
          ...
          <div className="input-area">
            <label htmlFor="select" className="form-label">
              Affiliated By<span style={{ color: "red" }}>*</span>
            </label>
            <Select
              options={optionsaff}
              ...
              placeholder="Select options..."
              value={options.find(
                (selectedOption) => selectedOption.value === affby
              )}
              onChange={(selectedOption) =>
                setAffby(selectedOption ? selectedOption.value : null)
              }
            />
          </div>
          ...
          <div className="input-area">
            <label htmlFor="select" className="form-label">
              Approaved By<span style={{ color: "red" }}>*</span>
            </label>
            <Select
              options={optionsapp}
              closeMenuOnSelect={true}
              placeholder="Select options..."
              value={options.find(
                (selectedOption) => selectedOption.value === appby
              )}
              onChange={(selectedOption) =>
                setAppby(selectedOption ? selectedOption.value : null)
              }
            />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
          <div className="input-area">
            <label htmlFor="select" className="form-label">
              Course Mapping<span style={{ color: "red" }}>*</span>
            </label>
            <Select
              options={optionsmap}
              isMulti
              ...
              placeholder="Select options..."
              value={options.find(
                (selectedOption) => selectedOption.value === mapping
              )}
              onChange={(selectedOptions) =>
                setMapping(selectedOptions.map((option) => option.value))
              }
            />
          </div>
          ...
          <div className="input-area">
            <label htmlFor="select" className="form-label">
              Exam Accepted Mapping<span style={{ color: "red" }}>*</span>
            </label>
            <Select
              id="first-select"
              options={optionsfir}
              ...
              value={optionsfir.find(
                (selectedOption) => selectedOption.value === examacc
              )}
              onChange={(selectedOptions) =>
                setExamacc(selectedOptions.map((option) => option.value))
              }
              isSearchable
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-7">
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              Main Course<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              Yearly Fee<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              Main Entrance Exam Name<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              className="form-control"
              placeholder="Main Entrance Exam Name"
              value={entname}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-7">
          <div className="input-area">
            <label htmlFor="select" className="form-label">
              Gender Acceptance<span style={{ color: "red" }}>*</span>
            </label>
            <Select
              ...
              placeholder="Select options..."
              value={options.find(
                (selectedOption) => selectedOption.value === gender
              )}
              onChange={(selectedOption) =>
          ...
          <div className="input-area relative">
            <label for="largeInput" className="form-label">
              Years Funded<span style={{ color: "red" }}>*</span>
            </label>
            <input
              type="text"
              className="form-control"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-7">
          <div className="input-area">
            ...
            <Select
              ...
              value={optionscountries.find(
                (selectedOption) => selectedOption.value === allcount
              )}
              onChange={(selectedOption) =>
                setAllcount(selectedOption ? selectedOption.value : null)
              }
            />
          </div>
          ...
          <div className="input-area">
            ...
            <Select
              ...
              closeMenuOnSelect={true}
              placeholder="Select options..."
              value={optionszone.find(
                (selectedOption) => selectedOption.value === zone
              )}
              onChange={(selectedOption) =>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-7">
          <div>
            {mail.map((email, index) => (
              ...
              >
                <label htmlFor={`email-${index}`} className="form-label flex">
                  Email
                </label>
                <input
                  type="email"
            ...
            <button
              className="btn inline-flex justify-center btn-outline mt-3 bg-green-400"
              type="button"
          ...
          <div>
            {mob.map((number, index) => (
              <div
                ...
                style={{ marginTop: "10px" }}
              >
                <label htmlFor={`mob-${index}`} className="form-label flex">
                  Number
                </label>
                <input
                  type="number"
        ...
        <button
          className="btn inline-flex justify-center btn-outline-dark"
          type="submit"
        >
          Next
        </button>
