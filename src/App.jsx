...
const NewdashboardPage = lazy(() => import("./pages/dashboard/newdashboard"));
...
import PageUpdate from "./pages/exams/updateexam";
import AddCoursesar from "./pages/courses/UpdateCourses";
import AddNotificationModal from "./pages/exams/updateexam/Notification";
// import Child from "./pages/exams/updateexam/Child";
...
const ManageProductArticle = lazy(() =>
  import("./pages/Product Article/ManageArticle")
);
    ...
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          ...
          <Route path="addExam/:name" element={<PageUpdate />} />
          {/* <Route path="addExam/:name/:slug" element={<Child />} /> */}
          ...
          <Route path="addcourse/:title" element={<AddCoursesar />} />
